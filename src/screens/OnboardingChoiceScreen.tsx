...
const OnboardingChoiceScreen = ({ onHaveIdea, onBrainstorm }: OnboardingChoiceScreenProps) => {
  ...
  const handleContinue = () => {
    if (selected === "idea") onHaveIdea();else
    if (selected === "brainstorm") onBrainstorm();
  };
      ...
      <div className="flex-1 px-5">
        <motion.div
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-2">Choose how you want to start your entreprenership journey today
              <br />journey today.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <motion.button
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Refine your vision and start building your dream business
                  <br />start building your product.
                </p>
              </div>
              {selected === "idea" ?
            ...
            <motion.button
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mt-0.5">Chat with our AI and evaluate right idea for you
                  <br />find your next big thing.
                </p>
              </div>
              {selected === "brainstorm" ?
              <div className="w-6 h-6 rounded-full bg-primary flex items-center justify-center">
